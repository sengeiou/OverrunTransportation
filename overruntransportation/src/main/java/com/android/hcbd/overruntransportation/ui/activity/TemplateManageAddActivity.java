...
public class TemplateManageAddActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_template_manage_add);
        ButterKnife.bind(this);
        type = getIntent().getStringExtra("type");

        if(type.equals("add")){
            tv_title.setText("模版管理录入");
        }else{
            dataInfo = (TemplateManageInfo.DataInfo) getIntent().getSerializableExtra("data");
            tv_title.setText("模版管理修改");
        ...
        OkGo.<String>post(MyApplication.getInstance().getBsaeUrl()+HttpUrlUtils.save_word_list_url)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onStart(Request<String, ? extends Request> request) {
                        ...
                        dialogUtils.showLoading(TemplateManageAddActivity.this);
                    }
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            if(!TextUtils.isEmpty(jsonObject.getString("data"))){
                                ToastUtils.showShortToast(TemplateManageAddActivity.this,jsonObject.getString("data"));
                                if(type.equals("add")){
                                    messageEvent.setEventId(MessageEvent.EVENT_TEMPLATE_LIST_ADD);
                                }else{
                                    messageEvent.setEventId(MessageEvent.EVENT_TEMPLATE_LIST_EDIT);
        ...
        AndPermission.with(this)
                ...
                .rationale(new RationaleListener() {
                    ...
                    public void showRequestPermissionRationale(int requestCode, Rationale rationale) {
                        ...
                        AndPermission.rationaleDialog(TemplateManageAddActivity.this, rationale).show();
                    }
                })
                .start();
    }
