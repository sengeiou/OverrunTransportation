...
import com.android.hcbd.overruntransportation.adapter.WordListAdapter;
...
public class WordListActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onMessageEvent(MessageEvent event) {
        switch (event.getEventId()){
            case MessageEvent.EVENT_WORD_LIST_ADD:
                currentPage = 1;
                initHttpData();
                break;
            case MessageEvent.EVENT_WORD_LIST_EDIT:
                ...
                break;
            case MessageEvent.EVENT_WORD_LIST_DEL:
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            if(1 == currentPage){
                                adapter = new WordListAdapter(WordListActivity.this,dataInfoList);
            ...
            case R.id.iv_search:
                ...
                searchFragment.setOnSearchClickListener(new IOnSearchClickListener() {
                    ...
                    public void OnSearchClick(String keyword) {
                        searchStr = keyword ;
                        dialogUtils.showLoading(WordListActivity.this);
                        currentPage = 1;
                        initHttpData();
                    }
                });
