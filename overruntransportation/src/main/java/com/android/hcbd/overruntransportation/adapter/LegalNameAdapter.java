...
public class LegalNameAdapter extends BaseAdapter{
    private Context context;
    private List<LegalNameInfo.DataInfo> list;
    private int position;
    public LegalNameAdapter(Context context, List<LegalNameInfo.DataInfo> list){
                                    ...
                                    public void onSuccess(Response<String> response) {
                                        ...
                                        try {
                                            ...
                                            if(!TextUtils.isEmpty(jsonObject.getString("data"))){
                                                ...
                                                MessageEvent messageEvent = new MessageEvent(MessageEvent.EVENT_LEGAL_NAME_LIST_DEL);
