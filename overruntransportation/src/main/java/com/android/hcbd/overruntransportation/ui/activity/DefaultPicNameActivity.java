...
import com.android.hcbd.overruntransportation.adapter.DefaultPicNameAdapter;
...
public class DefaultPicNameActivity extends BaseActivity implements View.OnClickListener{
    ...
    private List<DefaultProblemInfo.DataInfo> dataInfoList = new ArrayList<>();
    private DefaultPicNameAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_default_pic_name);
    ...
    public void onMessageEvent(MessageEvent event) {
        switch (event.getEventId()){
            case MessageEvent.EVENT_DEFAULT_PROBLEM_LIST_EDIT:
                DefaultProblemInfo.DataInfo dataInfo = (DefaultProblemInfo.DataInfo) event.getObj();
                dataInfoList.set(adapter.getPosition(),dataInfo);
                adapter.notifyDataSetChanged();
                break;
            case MessageEvent.EVENT_DEFAULT_PROBLEM_LIST_ADD:
                currentPage = 1;
                initHttpData();
                break;
            case MessageEvent.EVENT_DEFAULT_PROBLEM_LIST_DEL:
    ...
    private void initListener() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(DefaultPicNameActivity.this,DefaultPicNameAddActivity.class);
                intent.putExtra("type","edit");
                intent.putExtra("data", dataInfoList.get(i));
                intent.putExtra("list", (Serializable) dataInfoList);
    ...
    private void initHttpData() {
        OkGo.<String>post(MyApplication.getInstance().getBsaeUrl()+HttpUrlUtils.default_problem_list_url)
                .params("sessionOper.code", MyApplication.getInstance().getLoginInfo().getUserInfo().getCode())
                .params("sessionOper.orgCode",MyApplication.getInstance().getLoginInfo().getUserInfo().getOrgCode())
                .params("token",MyApplication.getInstance().getLoginInfo().getToken())
                .params("params","A009")
                .params("currentPage",currentPage)
                .params("nspType.name",TextUtils.isEmpty(searchStr)?"":searchStr)
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            for(int i=0;i<array.length();i++){
                                DefaultProblemInfo.DataInfo dataInfo = gson.fromJson(array.getString(i),DefaultProblemInfo.DataInfo.class);
                                dataInfoList.add(dataInfo);
                            }

                            if(1 == currentPage){
                                adapter = new DefaultPicNameAdapter(DefaultPicNameActivity.this,dataInfoList);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.iv_search:
                ...
                searchFragment.setOnSearchClickListener(new IOnSearchClickListener() {
                    ...
                    public void OnSearchClick(String keyword) {
                        searchStr = keyword ;
                        dialogUtils.showLoading(DefaultPicNameActivity.this);
                        currentPage = 1;
                        initHttpData();
                    }
                });
            ...
            case R.id.iv_edit:
                ...
                Intent intent = new Intent(this,DefaultPicNameAddActivity.class);
