...
import com.android.hcbd.overruntransportation.adapter.LegalNameAdapter;
...
public class LegalNameListActivity extends BaseActivity implements View.OnClickListener {
    ...
    private List<LegalNameInfo.DataInfo> dataInfoList = new ArrayList<>();
    private LegalNameAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legal_name_list);
    ...
    public void onMessageEvent(MessageEvent event) {
        switch (event.getEventId()){
            case MessageEvent.EVENT_LEGAL_NAME_LIST_EDIT:
                LegalNameInfo.DataInfo dataInfo = (LegalNameInfo.DataInfo) event.getObj();
                dataInfoList.set(adapter.getPosition(),dataInfo);
                adapter.notifyDataSetChanged();
                break;
            case MessageEvent.EVENT_LEGAL_NAME_LIST_ADD:
                currentPage = 1;
                initHttpData();
                break;
            case MessageEvent.EVENT_LEGAL_NAME_LIST_DEL:
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            for(int i=0;i<array.length();i++){
                                LegalNameInfo.DataInfo dataInfo = gson.fromJson(array.getString(i),LegalNameInfo.DataInfo.class);
                                dataInfoList.add(dataInfo);
                            }

                            if(1 == currentPage){
                                adapter = new LegalNameAdapter(LegalNameListActivity.this,dataInfoList);
    ...
    private void initListener() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(LegalNameListActivity.this,LegalNameAddActivity.class);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.iv_search:
                ...
                searchFragment.setOnSearchClickListener(new IOnSearchClickListener() {
                    ...
                    public void OnSearchClick(String keyword) {
                        searchStr = keyword ;
                        dialogUtils.showLoading(LegalNameListActivity.this);
                        currentPage = 1;
                        initHttpData();
                    }
                });
            ...
            case R.id.iv_edit:
                ...
                Intent intent = new Intent(this,LegalNameAddActivity.class);
