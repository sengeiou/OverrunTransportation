...
public class TemplateManageAdapter extends BaseAdapter {
    private Context context;
    private List<TemplateManageInfo.DataInfo> list;
    private int position;
    public TemplateManageAdapter(Context context,List<TemplateManageInfo.DataInfo> list){
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null){
            view = LayoutInflater.from(context).inflate(R.layout.item_template_manage_layout,null);
                                    ...
                                    public void onSuccess(Response<String> response) {
                                        ...
                                        try {
                                            ...
                                            if(!TextUtils.isEmpty(jsonObject.getString("data"))){
                                                ...
                                                MessageEvent messageEvent = new MessageEvent(MessageEvent.EVENT_TEMPLATE_LIST_DEL);
                ...
                OkGo.<File>post(MyApplication.getInstance().getBsaeUrl()+HttpUrlUtils.download_word_url)
                        ...
                        .execute(new FileCallback(MyApplication.getInstance().getSDPath()+"/tps/download/",list.get(i).getUploadFileName()) {
                            ...
                            public void onStart(Request<File, ? extends Request> request) {
                                super.onStart(request);
                                ToastUtils.showShortToast(context,"正在下载模版...");
                            }

                            @Override
                            public void onSuccess(Response<File> response) {
                                ToastUtils.showShortToast(context,"模版下载完成。");
                                AlertDialog.Builder builder = new AlertDialog.Builder(context);
                                builder.setTitle("模版下载完成");
