...
import com.android.hcbd.overruntransportation.adapter.LawInfoAdapter;
...
public class LawInfoListActivity extends BaseActivity implements View.OnClickListener {
    ...
    private List<LawInfoInfo.DataInfo> dataInfoList = new ArrayList<>();
    private LawInfoAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_law_info_list);
    ...
    public void onMessageEvent(MessageEvent event) {
        switch (event.getEventId()){
            case MessageEvent.EVENT_LAW_INFO_LIST_ADD:
                currentPage = 1;
                initHttpData();
                break;
            case MessageEvent.EVENT_LAW_INFO_LIST_EDIT:
                LawInfoInfo.DataInfo dataInfo = (LawInfoInfo.DataInfo) event.getObj();
                dataInfoList.set(adapter.getPosition(),dataInfo);
                adapter.notifyDataSetChanged();
                break;
            case MessageEvent.EVENT_LAW_INFO_LIST_DEL:
    ...
    private void initHttpData() {
        OkGo.<String>post(MyApplication.getInstance().getBsaeUrl()+HttpUrlUtils.law_info_list_url)
                .params("sessionOper.code", MyApplication.getInstance().getLoginInfo().getUserInfo().getCode())
                .params("sessionOper.orgCode",MyApplication.getInstance().getLoginInfo().getUserInfo().getOrgCode())
                .params("token",MyApplication.getInstance().getLoginInfo().getToken())
                .params("currentPage",currentPage)
                .params("tpsLaw.name",TextUtils.isEmpty(searchStr)? "":searchStr)
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            for(int i=0;i<array.length();i++){
                                LawInfoInfo.DataInfo dataInfo = gson.fromJson(array.getString(i),LawInfoInfo.DataInfo.class);
                                dataInfoList.add(dataInfo);
                            }

                            if(1 == currentPage){
                                adapter = new LawInfoAdapter(LawInfoListActivity.this,dataInfoList);
    ...
    private void initListener() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(LawInfoListActivity.this, LawInfoAddActivity.class);
                intent.putExtra("type","edit");
                intent.putExtra("oid",dataInfoList.get(i).getId());
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.iv_edit:
                ...
                Intent intent = new Intent(this,LawInfoAddActivity.class);
            ...
            case R.id.iv_search:
                ...
                searchFragment.setOnSearchClickListener(new IOnSearchClickListener() {
                    ...
                    public void OnSearchClick(String keyword) {
                        searchStr = keyword ;
                        dialogUtils.showLoading(LawInfoListActivity.this);
                        currentPage = 1;
                        initHttpData();
                    }
                });
