...
public class DefaultProblemAddActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_default_problem_add);
    ...
    private void initData() {
        ...
        if(type.equals("add")){
            tv_title.setText("默认问题录入");
        }else{
            tv_title.setText("默认问题修改");
        ...
        switch (view.getId()){
            ...
            case R.id.iv_save:
                if(TextUtils.isEmpty(et_code.getEditableText().toString())){
                    ToastUtils.showShortToast(this,"请输入默认问题编号");
                    return;
                }
                if(TextUtils.isEmpty(et_name.getEditableText().toString())){
                    ToastUtils.showShortToast(this,"请输入默认问题名称");
                    return;
                }
                if(type.equals("add")){
                    boolean isAdd = false;
    ...
    private void saveData() {
        ...
        OkGo.<String>post(MyApplication.getInstance().getBsaeUrl()+HttpUrlUtils.add_edit_default_problem_url)
                ...
                .params("typeNote", "问题列表")
                .execute(new StringCallback() {
                    @Override
                    public void onStart(Request<String, ? extends Request> request) {
                        super.onStart(request);
                        dialogUtils.showLoading(DefaultProblemAddActivity.this);
                    }
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            if(!TextUtils.isEmpty(jsonObject.getString("data"))){
                                ...
                                if(type.equals("add"))
                                    ToastUtils.showShortToast(DefaultProblemAddActivity.this,"添加成功！");
                                else
                                    ToastUtils.showShortToast(DefaultProblemAddActivity.this,"修改成功！");
