...
import com.android.hcbd.overruntransportation.adapter.DefaultProblemAdapter;
...
public class DefaultProblemActivity extends BaseActivity implements View.OnClickListener {
    ...
    private DefaultProblemAdapter adapter;
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            if(1 == currentPage){
                                adapter = new DefaultProblemAdapter(DefaultProblemActivity.this,dataInfoList);
    ...
    private void initListener() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(DefaultProblemActivity.this,DefaultProblemAddActivity.class);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.iv_edit:
                ...
                Intent intent = new Intent(this,DefaultProblemAddActivity.class);
            ...
            case R.id.iv_search:
                ...
                searchFragment.setOnSearchClickListener(new IOnSearchClickListener() {
                    ...
                    public void OnSearchClick(String keyword) {
                        searchStr = keyword ;
                        dialogUtils.showLoading(DefaultProblemActivity.this);
                        currentPage = 1;
                        initHttpData();
                    }
                });
