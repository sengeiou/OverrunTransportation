...
import com.android.hcbd.overruntransportation.adapter.TemplateManageAdapter;
...
public class TemplateManageActivity extends BaseActivity implements View.OnClickListener {
    ...
    private List<TemplateManageInfo.DataInfo> dataInfoList = new ArrayList<>();
    ...
    public void onMessageEvent(MessageEvent event) {
        switch (event.getEventId()){
            case MessageEvent.EVENT_TEMPLATE_LIST_ADD:
                currentPage = 1;
                initHttpData();
                break;
            case MessageEvent.EVENT_TEMPLATE_LIST_EDIT:
                TemplateManageInfo.DataInfo dataInfo = (TemplateManageInfo.DataInfo) event.getObj();
                dataInfoList.set(adapter.getPosition(),dataInfo);
                adapter.notifyDataSetChanged();
                break;
            case MessageEvent.EVENT_TEMPLATE_LIST_DEL:
    ...
    private void initHttpData() {
        OkGo.<String>post(MyApplication.getInstance().getBsaeUrl()+HttpUrlUtils.template_manage_list_url)
                .params("sessionOper.code", MyApplication.getInstance().getLoginInfo().getUserInfo().getCode())
                .params("sessionOper.orgCode",MyApplication.getInstance().getLoginInfo().getUserInfo().getOrgCode())
                .params("token",MyApplication.getInstance().getLoginInfo().getToken())
                .params("currentPage",currentPage)
                .params("tpsWord.uploadFileName",TextUtils.isEmpty(searchStr)?"":searchStr)
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            for(int i=0;i<array.length();i++){
                                TemplateManageInfo.DataInfo dataInfo = gson.fromJson(array.getString(i),TemplateManageInfo.DataInfo.class);
                                dataInfoList.add(dataInfo);
                            }

                            if(1 == currentPage){
                                adapter = new TemplateManageAdapter(TemplateManageActivity.this,dataInfoList);
    ...
    private void initListener() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(TemplateManageActivity.this, TemplateManageAddActivity.class);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.iv_edit:
                ...
                Intent intent = new Intent(this,TemplateManageAddActivity.class);
            ...
            case R.id.iv_search:
                ...
                searchFragment.setOnSearchClickListener(new IOnSearchClickListener() {
                    ...
                    public void OnSearchClick(String keyword) {
                        searchStr = keyword ;
                        dialogUtils.showLoading(TemplateManageActivity.this);
                        currentPage = 1;
                        initHttpData();
                    }
                });
